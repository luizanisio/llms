...
python /students/luiz.abatitucci/llms/src/comparar_extracoes.py --config /students/luiz.abatitucci/llms/experimentos/summa_experimento/03_compara_q235_full.yaml
