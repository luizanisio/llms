...
# Nome do job
#SBATCH --job-name=treinar_puil_full
...
# CPUs disponíveis para o processo Python
...
#SBATCH --output=/students/luiz.abatitucci/llms/experimentos/puil-mini-experimento/jobs_logs/%x_%j.out

# Arquivo de saída de erros: <job-name>_<job-id>.err
#SBATCH --error=/students/luiz.abatitucci/llms/experimentos/puil-mini-experimento/jobs_logs/%x_%j.err
