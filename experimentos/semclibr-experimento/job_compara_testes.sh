...
#SBATCH --job-name=semclinbr-compara-testes
...
# não roda o 03_compara_gold_full.yaml pois já fez a divisão de dificuldade e incorporou a divisão de treino/teste/validação
