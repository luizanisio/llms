...
SRC = os.path.join(_BASE, "compara", "analises_comparacao_pubmed (full)",
                   "divisoes", "divisao_Professor_Qwen1_5B.csv")
DST = os.path.join(_BASE, "compara", "analises_comparacao_pubmed (full)",
                   "divisoes", "divisao_Professor_Qwen1_5B_blocos.csv")
