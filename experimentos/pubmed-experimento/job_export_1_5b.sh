...
#SBATCH --output=/students/luiz.abatitucci/llms/experimentos/pubmed-experimento/PubMed_20k_RCT/jobs_logs/%x_%j.out

# Arquivo de saída de erros: <job-name>_<job-id>.err
#SBATCH --error=/students/luiz.abatitucci/llms/experimentos/pubmed-experimento/PubMed_20k_RCT/jobs_logs/%x_%j.err
