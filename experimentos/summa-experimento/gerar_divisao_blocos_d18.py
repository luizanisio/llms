...
Equivalente ao script de mesmo nome do pubmed-experimento, apontando para a
divisão do summa (Qwen235b → Qwen7b).
...
_DIV = os.path.join(_BASE, "compara", "analises_comparacao_summa_q235 (full-base)", "divisoes")
SRC = os.path.join(_DIV, "divisao_Qwen235b_Qwen7b.csv")
DST = os.path.join(_DIV, "divisao_Qwen235b_Qwen7b_blocos.csv")
